...
```{r AvengersPlot, fig.cap="Avengers Budget v/s Gross", fig.align="center"}
...
```{r AvengersReview, fig.cap="Avengers Popularity", fig.align="center"}
...
```{r SpiderManPlot, fig.cap="Spider-Man Budget v/s Gross", fig.align="center"}
...
```{r SpiderManReview, fig.cap="Spider-Man Popularity", fig.align="center"}
reviewdata %>% select(Title, Year, Production_Company, User_Reviews, Critic_Reviews) %>% 
  filter(Title %in% c("Spider-Man", "Spider-Man 2", "Spider-Man 3", "The Amazing Spider-Man", "The Amazing Spider-Man 2", "Spider-Man: Homecoming", "Spider-Man: Far from Home")) %>% 
  ggplot(aes(x = Critic_Reviews, y = User_Reviews, color = Title, label = Year)) +
  geom_point() +
...
```{r AllReviewsPlot, fig.cap="All-time Popularity", fig.width=12, fig.height=6, fig.align="center"}
reviewdata %>%
...
```{r AllGrossPlot, fig.width=10, fig.align="center"}
