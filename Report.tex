...
\author{\sf\Large\textbf{Mr  }\\ {\sf\large Master of Business Analytics\\[0.5cm]} \sf\Large\textbf{Ms Wang Xue}\\ {\sf\large Master of Business\\[0.5cm]} \sf\Large\textbf{Mr Rahul Bharadwaj Mysore Venkatesh}\\ {\sf\large Master of Business Analytics\\[0.5cm]} \sf\Large\textbf{Mr Aryan Jain}\\ {\sf\large Master of Business Analytics\\[0.5cm]}}

\date{\sf\Date~\Month~\Year}
\makeatletter
\lfoot{\sf , Xue, Mysore Venkatesh, Jain: \@date}
\makeatother
